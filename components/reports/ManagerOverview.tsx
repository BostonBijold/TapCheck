...
// the pre-split Analytics tab (see docs/features/reports.md). Fetches
// GET /api/reports, which now branches server-side by role, but for a
// manager the response shape and content are byte-identical to before.
