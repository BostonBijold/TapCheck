...
// This is a Sunday–Saturday calendar week, distinct from the Monday-anchored
// ISO week used by virtue rotation and weekly review (see lib/virtue-dates.ts)
// — StreakDots and the Analytics 7-day view use this one instead.
